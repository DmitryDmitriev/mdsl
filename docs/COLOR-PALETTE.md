...
>
> **План гармонизации → отмашка дана (2026-07-01), тикет [PB-1583](https://larixon.atlassian.net/browse/PB-1583):** привести Warning к **Amber**-шкале целиком (Filled тоже на Amber/50/800/900, нужно добавить эти shade'ы в §1.6). Причина выбора в пользу Amber: (1) Orange уже занят `Decor/Orange` (§1.6) для marketing-меток — оставлять Warning на Orange = смешивать semantic и decor роли; (2) Amber семантически ближе к «warning» в индустрии (Material 3, Tailwind, iOS systemYellow). Затронет: Badge Filled-Warning, Alert/Dialog warning, Snackbar warning. Требует миграции Figma variables + iOS/Android sync.
>
> До выполнения PB-1583 — обе hue валидны, код следует текущей спеке (Filled = Orange), **не править инстансы вручную в продуктовых файлах**. Зафиксировано 2026-05-29; целевая hue Amber подтверждена дизайном 2026-07-01 (Android dev-sync LAA-3524).

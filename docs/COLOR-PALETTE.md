...
При работе с цветами в UI (макеты Figma, код) используйте только токены из этой спецификации. Семантические привязки зафиксированы в проде и не меняются.
...
### 2.6 Decor / Bubble
Бейджи, пузыри, декоративные подложки.
...
| Answer   | Blue/100      | Blue/800     |
| Admin    | Green/100     | Green/800    |
| Tech     | Background Tertiary | Zinc/600  |

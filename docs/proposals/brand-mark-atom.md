...
**Статус:** ⚠️ **SUPERSEDED 2026-06-01.** Атом Brand Mark был ratified 2026-05-20, но 2026-06-01 удалён как избыточный — его задачу (40 × 40 wrapper + Logo 32 × 32) решает inline auto-layout frame в Type=Checkbox + Brand variant'е List Item. Никакой собственной логики у атома не было — только padding. Текущая реализация описана в [list-item-spec.md](../list-item-spec.md) §3 «Composite Type=Checkbox + Brand».

Документ оставлен как trail обсуждения для будущего понимания, почему атом сначала появился и почему был свёрнут.

⚠️ Реальное устройство атома отличалось от первоначального proposal'а: после тестирования с реальными лого из Assets ушли от круглого + border'а к квадратному + прозрачному.

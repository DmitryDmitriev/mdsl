...
**Статус:** ✅ **RATIFIED 2026-05-20.** Финальная спека — [brand-mark-spec.md](../brand-mark-spec.md). Этот документ оставлен как trail обсуждения для будущего понимания, почему атом устроен именно так.

⚠️ Реальное устройство атома отличается от первоначального proposal'а: после тестирования с реальными лого из Assets ушли от круглого + border'а к квадратному + прозрачному (см. §8 спеки — раздел «История»).

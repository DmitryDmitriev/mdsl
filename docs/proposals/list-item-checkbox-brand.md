...
**Статус:** ✅ **RATIFIED 2026-05-20.** Финальная спека — [list-item-spec.md](../list-item-spec.md) §3 «Composite Type=Checkbox + Brand». Этот документ оставлен как trail обсуждения.

⚠️ Реальные параметры variant'а отличаются от первоначального proposal'а: gap 12 (не 8), paddingLeft 8 для выравнивания чекбоксов в колонку с другими variant'ами. См. финальную спеку.

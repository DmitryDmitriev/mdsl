...
|---|---|---|---|
| Yes | 4 (иконка в 16 от края) | Yes | 4 (иконка в 16 от края) |
| No | 16 (контент в 16 от края) | No | 16 (контент в 16 от края) |
...
| **Trailing 1** | on | Одно правое действие есть почти всегда (при Trailing=Yes) |
| **Trailing 2** | **off** | Второе действие — по запросу |
| **Trailing 3** | **off** | Третье действие — редкий кейс |

Boolean Trailing 1/2/3 действуют **только при Trailing=Yes**.
...
Leading=Yes / Trailing=Yes: root.padding = 4 (иконка видима в 16 от края)
Leading=No  / Trailing=No:  root.padding = 16 (контент в 16 от края)
...
├── Trailing 1 (INSTANCE .=Trailing Slot, только при Trailing=Yes, boolean)
├── Trailing 2 (INSTANCE .=Trailing Slot, только при Trailing=Yes, boolean)
└── Trailing 3 (INSTANCE .=Trailing Slot, только при Trailing=Yes, boolean)
```
...
| Padding right (Trailing=Yes) | 4 | `spacing/1` |
| Padding right (Trailing=No) | 16 | `spacing/4` |
...
| **Padding right (Trailing=Yes)** | `spacing/1` (4) |
| **Padding right (Trailing=No)** | `spacing/4` (16) |

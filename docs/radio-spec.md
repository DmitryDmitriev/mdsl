...
**2026-05-11 — аудит готовности (component-spec-check) — чисто.**

Все варианты на canonical-токенах, структура соответствует §3 (Outer Ring + Inner Dot). Покрытие — 100%. Правок не потребовалось. Radio → ✅ готов к разработке.
